...
## Sprints 12–14 — ML field-boundary detection (REMOVED)

> Historical FTW / deep-learning boundary detection work (Docker ML worker,
> Celery ML queue, detection API, and `/farms/[id]/detect` UI) was fully
> removed from the codebase. Manual draw + GeoJSON import remain for field
> boundaries. See Alembic `0015_drop_detected_boundaries`.
