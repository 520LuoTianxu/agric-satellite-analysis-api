...
-- base_id 与 land_parcels.base_id 一致，user_id 来自 jointLoginData.accountRoleList[0].accountId。
BEGIN;
...
COMMENT ON COLUMN agric_satellite.alert_reads.user_id IS '联合登录 accountRoleList 第一项的 accountId，不是 accountRoleId 或 token';
